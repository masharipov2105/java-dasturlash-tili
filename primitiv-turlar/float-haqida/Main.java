...
public class Main{
    ...
    public static void main(String[] args){
        ...
        System.out.println("float tipidagi qimatni olib uni Float wrapper sinfiga o'rab obekt yaratadi va qiymatini float da qayatradi: Float.valueOf(10.5f) " + Float.valueOf(son1));
